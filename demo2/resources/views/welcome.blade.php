...
<header class="w3-display-container w3-content w3-hide-small" style="max-width:1500px">
  <img class="w3-image" src="https://via.placeholder.com/1500x700.png?text=London" alt="London" width="1500" height="700">
...
<div class="w3-content" style="max-width:1100px;">
  ...
  <div class="w3-row-padding w3-text-white w3-large">
    <div class="w3-half w3-margin-bottom">
      <div class="w3-display-container">
        <img src="https://via.placeholder.com/500x300.png?text=Cinque+Terre" alt="Cinque Terre" style="width:100%">
    ...
    <div class="w3-half">
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="https://via.placeholder.com/500x300.png?text=New+York" alt="New York" style="width:100%">
            <span class="w3-display-bottomleft w3-padding">New York</span>
          </div>
        </div>
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="https://via.placeholder.com/500x300.png?text=San+Francisco" alt="San Francisco" style="width:100%">
      ...
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="https://via.placeholder.com/500x300.png?text=Pisa" alt="Pisa" style="width:100%">
            <span class="w3-display-bottomleft w3-padding">Pisa</span>
          </div>
        </div>
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="https://via.placeholder.com/500x300.png?text=Paris" alt="Paris" style="width:100%">
  ...
  <div class="w3-row-padding">
    <div class="w3-half w3-margin-bottom">
      <img src="{{ asset('images/norway.jpg') }}" alt="Norway" style="width:100%">
    ...
    <div class="w3-half w3-margin-bottom">
      <img src="{{ asset('images/Austrelia.jpg') }}" alt="Austria" style="width:100%">
      <div class="w3-container w3-white">
  ...
  <div class="w3-container">
    ...
    <form action="/action_page.php" target="_blank">
      ...
      <button class="w3-button w3-black w3-margin-top" type="submit">Send Message</button>
    </form>
  </div>
...
<footer class="w3-container w3-center w3-opacity w3-margin-bottom">
  ...
  <div class="w3-xlarge w3-padding-16">
    <a href="#" class="w3-hover-opacity"><i class="fa fa-facebook-official"></i></a>
    <a href="#" class="w3-hover-opacity"><i class="fa fa-instagram"></i></a>
    <a href="#" class="w3-hover-opacity"><i class="fa fa-snapchat"></i></a>
    <a href="#" class="w3-hover-opacity"><i class="fa fa-pinterest-p"></i></a>
